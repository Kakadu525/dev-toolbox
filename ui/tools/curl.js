const CurlTool = {
  ...
  addHeader() {
    ...
    row.innerHTML = `
  <input type="text" class="curl-header-key themed-input" placeholder="Header name" style="flex: 1;">
  <input type="text" class="curl-header-value themed-input" placeholder="Header value" style="flex: 1;">
`;
